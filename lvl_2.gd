...
func _on_area_2d_6_body_entered(body: Node2D): quitar_vida(body)
func _on_area_2d_7_body_entered(body: Node2D): quitar_vida(body)
func _on_area_2d_8_body_entered(body: Node2D): quitar_vida(body)
